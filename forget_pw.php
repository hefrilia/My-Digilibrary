                            ...
                            <form action="forget_pw.php" method="POST">
                                <div class="col-md-12">
                                    ...
                                    <div class="mt-3 form-group">
                                        ...
                                        <input type="email" id="email" name="email" placeholder=" " class="form form-lg form-control mt-2">

                                    </div>
                                    <div class="mt-3 mb-3 form-group">
                                        <label for="password" style="margin-left:2%;">New Password: </label>
                                        <input type="password" id="new_password" name="new_password" placeholder=" " class="form form-lg form-control mt-2">
