                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item  ">
                            <a href="index_admin.php" class='sidebar-link'>
                        ...
                        <li class="sidebar-item  ">
                            <a href="form_buku_baru.php" class='sidebar-link'>
                                <i class="bi bi-grid-1x2-fill"></i>
                ...
                <div class="card-body">
                    <form method="POST" class="form-data" id="form-data">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_member" id="nama_member" class="form-control" placeholder="Masukkan Judul Buku" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_member" id="nama_member" class="form-control" placeholder="Masukkan Nama Penulis" required>
                            <input type="hidden" name="id_member" id="id_member" value="<?= $user['member_id'] ?>">
                        </div>
                        <div class="mb-3">
                            <label for="nama_buku" class="form-label">Jumlah Halaman</label>
                            <input type="text" name="nama_buku" id="nama_buku" class="form-control" placeholder="Masukkan Jumlah Halaman" required>
                            <input type="hidden" name="id_buku" id="id_buku">
                        </div>
                        <div class="mb-3">
                            <label for="nama_buku" class="form-label">Tahun Terbit</label>
                            <input type="text" name="nama_buku" id="nama_buku" class="form-control" placeholder="Masukkan Tahun Terbit" required>
                            <input type="hidden" name="id_buku" id="id_buku">
                        </div>
                        <!-- <div class="mb-3">
