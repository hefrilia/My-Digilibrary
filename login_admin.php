                            ...
                            <form action="#" method="POST">
                                <div class="col-md-12">
                                    ...
                                    <div class="mt-3 form-group">
                                        ...
                                        <input type="text" id="email" name="email" placeholder="Email : nancysmith24@gmail.com" class="form form-lg form-control mt-2">

                                    </div>
                                    <div class="mt-3 mb-3 form-group">
                                        <label for="password" style="margin-left:2%;">Password: </label>
                                        <input type="password" id="password" name="password" placeholder="Password : admin_secret1" class="form form-lg form-control mt-2">
                                    </div>
